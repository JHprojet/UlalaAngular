...
export class ActivationComponent implements OnInit {
  ...
  constructor(private accessService:AccessService, private routerService:Router, private UserService:UserService) { }
  ...
  public sendToken()
  {
    this.DisplayValidationOk = false;
    this.DisplayValidationError = false;
    this.UserService.UpdateActivationToken(this.accessService.getSession("Id"), this.Token).subscribe(() => {
      this.UserService.getUser(this.accessService.getSession("Id")).subscribe(result => {
  ...
  public ResendTokenByEmail()
  {
    this.DisplayResendTokenOk = false;
    this.DisplayResendTokenError = false;
    this.UserService.ResendToken(this.accessService.getSession("Id")).subscribe(success =>{
